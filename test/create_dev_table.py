...
def read_file(file_path, output_file_path):
    with open(file_path, 'r', encoding='utf-8') as csv_file:
        ...
        with open(output_file_path, 'w', encoding='utf-8', newline='') as output_file:
            ...
            writer.writerow(['ls', 'name', 'number', 'data_pov_next', 'location', 'type'])
            for row in rows:
...
if __name__ == "__main__":
    input_file_path = 'Users_home11.csv'  # Путь к вашему входному файлу
    output_file_path = 'MeterDev_home11.csv'  # Путь к выходному файлу
